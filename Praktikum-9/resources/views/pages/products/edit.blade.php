...
@section('konten')
    ...
    {{-- Tambahkan blok ini untuk melihat error validasi saat update --}}
    @if ($errors->any())
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="weight" value="{{ old('weight', $product->productDetail->weight ?? '') }}">
                            @error('weight')
                                <div class="form-text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="size" value="{{ old('size', $product->productDetail->size ?? '') }}">
                            @error('size')
                                <div class="form-text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
